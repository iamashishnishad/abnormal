...
#             if existing_file:
#                 logger.info(f"Duplicate found: {existing_file.original_filename}")
#                 # Create a duplicate entry with reference to the original
#                 data = {
#                     'file': file_obj,
#                     'original_filename': file_obj.name,
#                     'file_type': file_obj.content_type,
...
#                 existing_file.save()
#             else:
#                 logger.info("No duplicate found, creating new file entry")
...
#         try:
#             # Create a copy of the file for hash calculation
...
#             # Create a new file object for hash calculation
#             temp_file = InMemoryUploadedFile(
#                 file=file_buffer,
#                 field_name='file',
#                 name=file_obj.name,
...
#             # Create a new file object for saving
...
#                 # Create a duplicate entry with reference to the original
#                 data = {
#                     'file': new_file,  # Use the new file object
#                     'original_filename': file_obj.name,
#                     'file_type': file_obj.content_type,
#                     'size': file_obj.size,
#                     'file_hash': file_hash,
#                     'is_duplicate': True,
#                     'original_file': existing_file.id,
#                     'storage_saved': file_obj.size,  # Track storage savings
#                     'uploaded_at': timezone.now()
#                 }
